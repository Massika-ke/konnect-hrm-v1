<div>
    ...
    <form wire:submit="save" class="my-6 w-full space-y-6">
        <flux:input type="serach" name="search" wire:model.live="search" placeholder="Search for an Employee" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <flux:select name="designation" label="Designation" wire:model.live="designation_id">
