<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-4 mt-4">
        @foreach ($payrolls as $payroll)
        <div class="p-6 bg-nos-100 dark:bg-nos-900 text-nos-900 dark:text-white rounded-lg shadow-md">
            <div class="mb-4">
