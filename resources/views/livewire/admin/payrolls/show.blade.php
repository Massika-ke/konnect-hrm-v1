                    ...
                    <table class="min-w-full table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center bg-nos-100 hover:bg-nos-50 dark:bg-nos-900 dark:hover:bg-nos-700">
                                ...
                                <td>
                                    <span>
                                        <sup>KES</sup>{{ number_format($salary->gross_salary, 2) }}
                                    </span>
                                </td>
                                <td>
                                    <span>
                                        <sup>KES</sup>{{ number_format($salary->breakdown->getNssfDeduction(), 2) }}
                                    </span>
                                </td>
                                <td>
                                    <span>
                                        <sup>KES</sup>{{ number_format($salary->breakdown->getShifDeduction(), 2) }}
                                    </span>
                                </td>
                                <td>
                                    <span>
                                        <sup>KES</sup>{{ number_format($salary->breakdown->getAhlDeduction(), 2) }}
                                    </span>
                                </td>
                                <td>
                                    <span>
                                        <sup>KES</sup>{{ number_format($salary->breakdown->getPaye(), 2) }}
                                    </span>
                                </td>
                                <td>
                                    <span>
                                        <sup>KES</sup>{{ number_format($salary->breakdown->getNetPay(), 2) }}
                                    </span>
                                </td>
                                <td>
                                    <div>
                                        <flux:button variant="primary" :href="route('designations.edit', $designation->id)" wire:click="generatePayslip({{ $salary->id }})"/>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
